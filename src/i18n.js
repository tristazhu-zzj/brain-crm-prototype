export const t = {
  zh: {
    ...
    connectDescAdmin: '管理员已配置使用此 CRM，请授权你的个人账号以完成同步。',
    cancel: '取消',
    connect: '连接',
    ...
    participants: '人参与',
    transcript: '转写内容',
    fieldSelectTitle: '选择要同步的字段',
    fieldSelectConfirm: '确认并继续',
  },
  ja: {
    // Sidebar
    newChat: '新規チャット',
    ...
    connectDescAdmin: '管理者がこの CRM を設定済みです。同期を完了するには個人アカウントを認証してください。',
    cancel: 'キャンセル',
    connect: '連携する',
    ...
    refreshing: '取得中...',
    refreshDone: '更新済み',
    recommendedActions: 'Brain のおすすめ',
    ...
    participants: '名参加',
    transcript: '文字起こし',
    fieldSelectTitle: '同期するフィールドを選択',
    fieldSelectConfirm: '確認して続ける',
  },
}
